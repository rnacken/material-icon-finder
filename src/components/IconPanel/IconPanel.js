...
class IconPanel extends Component {
    ...
    submitNewTag(e) {
        ...
        if (!Object.keys(this.props.selectedIcon.tags).find(key => this.props.selectedIcon.tags[key] === tag)) {
            ...
            // tag already exists
            var toastHTML = '<span>This tag already exists</span>';
    ...
    getIconTags() {
        const iconTags = Object.keys(this.props.selectedIcon.tags).reverse().map((tagKey, i) => {
            if (this.state.showingAllTags || i < 10) {
                ...
                const tagAddedByUser = (this.state.addedTags.find(tagObj => {
                    return (this.props.selectedIcon.name === tagObj.icon.name
        ...
        if (!this.state.showingAllTags && Object.keys(this.props.selectedIcon.tags).length > 10) {
            iconTags.push(
                <div className="chip icon-tag icon-tag--show-all lime lighten-2" onClick={this.showAllTags.bind(this)} key="more-icons-btn">{Object.keys(this.props.selectedIcon.tags).length - 10}&nbsp;more...</div>
            );
        }
        return iconTags;
    }
    ...
    render() {
        ...
        if (this.props.selectedIcon) {
            ...
            return (
                <div className="icon-panel" ref="iconPanel">
                    ...
                    <div className="icon-panel__section-divider"></div>
                    <section className="icon-panel__section">
                        ...
                        <form action="" onSubmit={this.submitNewTag.bind(this)}>
                            <div className="icon-panel__input-fieldset">
                                <div className="input-field icon-panel__new-tag">
                                    ...
                                    <input className="icon-panel__new-tag__input"
                                        id="new-tag-input"
                                        ref="newTagRef"
                                        type="text"
        ...
        return (<div className="icon-panel" ref="iconPanel"></div>);
    }
}
